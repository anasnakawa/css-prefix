...
// Class definition
//
// * **param:** {string}   stream    content of a stylesheet
// * **param:** {object}   options
, Prefixer = function( stream, options ) {
  this.stream = stream;
...
Prefixer.prototype.processStream = function() {
  var self = this;
...
module.exports = function( stream, options ) {
  var prefixerInstance = new Prefixer( stream, options )
  , reworkInstance = rework( stream );

  reworkInstance
    .use( prefixerInstance.processStream() )
    .use(
      rework.mixin(
